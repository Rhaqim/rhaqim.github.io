    ...
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          ...
          <Link href="https://azenia.com">Azenia</Link> on contract to
          _.
        </Paragraph>
      ...
      <Section delay={0.2}>
        ...
        <BioSection>
          ...
          Graduated from the University of Benin with a Bachelor&apos;s in Computer Science.
        </BioSection>
        <BioSection>
          <BioYear>2020</BioYear>
          Started Learning Python at <Link href='https://univelcity.com'>UnivelCity</Link>.
        </BioSection>
        <BioSection>
      ...
      <Section delay={0.2}>
        ...
        <Paragraph>
          Music {' '}, Art {' '}, and Technology. I also ejoy playing video games and learning new things. I am an AI enthusiast and a fan of the {'Tensorflow'} framework.
        </Paragraph>
      </Section>
    </Container>
  )
